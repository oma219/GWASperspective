...
outdir <- "/gpfs/commons/groups/sanjana_lab/nsaravanan/sim_output"
dir.create(outdir, showWarnings = FALSE)
outfile <- file.path(
  outdir,
  paste0(
    "PIPs_locus", locus_idx,
    "_h2_", h2_val,
    "_N_", N_val,
    "_pi_", round(pi_val, 6),
    ".csv"
